...
<%@ page import="com.classdesign.domain.Movie" %><%--
...
<head>
    ...
    <link href="${pageContext.request.contextPath}/docs/examples/carousel/carousel.css" rel="stylesheet">
</head>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/view/coverpage.jsp">iMoive</a>
                </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="/source/img/5.jpg" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Example headline.</h1>
                    <p>Note: If you're viewing this page via a <code>www.baidu.com</code> URL, the "next" and "previous" Glyphicon buttons on the left and right might not load/display properly due to web browser security rules.</p>
...
<%--    %>--%>
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="/source/img/4.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>Heading</h2>
...
<script src="${pageContext.request.contextPath}/docs/assets/js/vendor/holder.min.js"></script>
<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
